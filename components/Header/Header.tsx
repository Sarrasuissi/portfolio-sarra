...
//                   {open && (
//                     <ul className="absolute top-8 left-0 bg-white shadow-md rounded-md py-2 w-48">
...
function Header() {
  return (
    <header className="fixed top-0 left-0 w-full z-50 font-[family-name:var(--font-outfit)] grid grid-cols-3 items-center px-6 py-4 bg-red-400">
      <Link href={"/"}>
        <img
          src="/assets/icons/logo-sarra-transparent.webp"
          alt="logo"
...
//           scrolled
//             ? "py-3 bg-black/80 backdrop-blur-xl border-b border-white/5 shadow-[0_8px_40px_rgba(0,0,0,0.4)]"
//             : "py-6 bg-transparent"
//         }`}
//       >
...
//           <Link
//             href="/"
//             className="flex items-center gap-2.5 group animate-[fadeInLeft_0.7s_ease_0.1s_both]"
//           >
//             <img
//               src="/assets/icons/logo-sarra-transparent.webp"
//               alt="logo"
//               className="h-9 w-auto transition-opacity duration-300 group-hover:opacity-70"
//             />
...
//                   <li
//                     key={index}
//                     className="relative group animate-[fadeInDown_0.6s_ease_both]"
...
//       {/* Keyframes via global style tag — add these to your globals.css instead */}
//       <style>{`
